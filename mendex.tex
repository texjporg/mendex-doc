...
\makeatother
\MakeShortVerb{\|}
\newverbcommand{\Param}{\item[}{]}
\newverbcommand{\ParamNum}{\jMeta{数値}\quad 規定値：}{\para}
\newverbcommand{\ParamChar}{\jMeta{文字}\quad 規定値：`}{'\para}
\newverbcommand{\ParamString}{\jMeta{文字列}\quad 規定値：``}{''\para}
...
パラメータの記述順序は自由です．また `|%|' 以降はコメントと見されます．
