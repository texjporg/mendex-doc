...
\item[|--version|]
ヴァージョンの情報を表示します．\footnote{|version 3.10 [5-Dec-2025]|で追加されました．}
% https://github.com/texjporg/tex-jp-build/issues/191
...
以上のうち，オプション |-U|, |-I|, |--[no-]guess-input-enc|, |--help|, |--version|, |--| は
